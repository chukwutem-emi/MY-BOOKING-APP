...
import HealthCareCounselingSessionDom from '../../AppointmentDOM/HealthcareCounselingSessionDom';
...
const HealthCareCounselingSessionAppointment = () => {
    ...
    const {
        ...
        message,
        setMessage
    } = useHealthcareCounselingSession();
    ...
    const handleCounselingSessionForm = (e) => {
        ...
        handleCounselingSessionPayload(payload);
    };
  return (
    <div className='overflow-x-hidden w-full'>
        <HealthCareCounselingSessionDom
        ...
        genderRef={genderRef}
        handleCounselingSessionForm={handleCounselingSessionForm}
...
export default HealthCareCounselingSessionAppointment;