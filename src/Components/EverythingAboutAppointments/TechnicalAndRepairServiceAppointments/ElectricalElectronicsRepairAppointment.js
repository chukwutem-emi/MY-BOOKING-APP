...
const ElectricalElectronicsRepair = () => {
    ...
    const handleElectricalElectronicsRepair = async (event) => {
        ...
        try {
            ...
            if (data.status === 401) {
                ...
                setMessage(`${json.electronics_repair}<br><a href=${json.googleCalenderLink} rel="noopener, noreferrer" target="_blank" title="click here" class="text-blue-500 justify-center items-center text-center font-semibold underline hover:text-lg hover:text-blue-800 my-0 mx-auto break-words">Click this link to view the electrical/electronics repair appointment you booked in google calender</a>`)
                setIsError(false);
            } else {
    ...
    return (
        <div className='mt-[16rem] overflow-x-hidden w-full items-center'>
            <form onSubmit={handleElectricalElectronicsRepair} className="w-[50%] space-y-4 my-0 mx-auto shadow-2xl bg-white flex flex-col p-4 rounded-2xl xs:w-[90%] sm:w-[90%] md:w-[90%] lg:w-[90%] xl:w-[50%]">
