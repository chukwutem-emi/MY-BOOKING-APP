...
const HomeServiceDom = ({handleHomeServiceForm, message, isError, isLoading, firstNameRef, lastNameRef, addressRef, emailAddressRef, userPhoneNumberRef, genderRef, amountRef, nextOfKinAddressRef, nextOfKinPhoneNumberRef, nextOfKinRef, appointmentDateRef, appointmentDescriptionRef, appointmentTimeRef}) => {
    return (
