...
const FinancialAdvisoryDom = ({handleFinancialAdvisoryAppointmentForm, message, isError, firstNameRef, lastNameRef, addressRef, emailAddressRef, userPhoneNumberRef, genderRef, nextOfKinRef, nextOfKinAddressRef, nextOfKinPhoneNumberRef, appointmentDateRef, appointmentDescriptionRef, appointmentTimeRef, amountRef, isLoading}) => {
    return (
