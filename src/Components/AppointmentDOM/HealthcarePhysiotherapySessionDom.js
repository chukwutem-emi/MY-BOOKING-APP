...
const HealthCarePhysiotherapySessionDom = ({handlePhysiotherapyAppointmentForm, message, isError, firstNameRef, lastNameRef, addressRef, genderRef, emailAddressRef, userPhoneNumberRef, nextOfKinAddressRef, nextOfKinPhoneNumberRef, nextOfKinRef, appointmentDateRef, appointmentTimeRef, appointmentDescriptionRef, isLoading, amountRef}) => {
    return (
        <form onSubmit={handlePhysiotherapyAppointmentForm} className="w-[50%] space-y-4 my-0 mx-auto shadow-2xl bg-white flex flex-col p-4 rounded-2xl xs:w-[90%] sm:w-[90%] md:w-[90%] lg:w-[90%] xl:w-[50%]">
