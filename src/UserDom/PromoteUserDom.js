...
const PromoteUserDom = ({emailRef, codeRef, message, setMessage, isLoading, handleClearMsg, handleUserPromotion, errorMsg}) => {
    return (
        <form onSubmit={handleUserPromotion} className="w-full mb-[2rem] xs:w-[90%] sm:w-[90%] md:w-[90%] lg:w-[90%] xl:w-[50%] mx-auto p-6 rounded-2xl flex flex-col bg-black space-y-4 shadow-2xl">
