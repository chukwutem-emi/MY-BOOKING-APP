...
const ProfessionalService = () => {
    ...
    return (
        <div className="relative flex flex-row w-full h-[25rem] whitespace-normal overflow-x-auto p-4 space-x-4">
            ...
            {
                services.map((item) => (
                    <Link to={item.link} key={item.title} className="w-full xs:w-[80%] sm:w-[80%] md:w-[80%] lg:w-[60%] xl:w-[50%] bg-gray-500 flex-shrink-0 p-2 h-full rounded-xl shadow-lg hover:p-4">
