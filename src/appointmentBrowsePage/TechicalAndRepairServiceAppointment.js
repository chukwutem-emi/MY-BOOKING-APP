...
const TechnicalRepair = () => {
    ...
    return (
        <div className="relative flex w-full h-[25rem] whitespace-normal space-x-4 overflow-x-auto p-4">
            ...
            {
                technical.map((item) => (
                    <Link to={item.link} key={item.title} className="bg-gray-500 shadow-xl rounded-xl flex-shrink-0 p-2 w-full xs:w-[90%] sm:w[80%] md:w-[80%] lg:w-[80%] xl:w-[50%] hover:p-4">
