...
const useHealthcarePhysiotherapySession = () => {
    ...
    const handlePhysiotherapyAppointment = async (event, payload) => {
        ...
        try {
            ...
            if (data.status === 401) {
                ...
                setMessage(`${json.Physiotherapy}<br><a href=${json.googleCalendarLink} rel="noopener, noreferrer" target="_blank" title="click here" class="text-blue-500 justify-center items-center text-center font-semibold underline hover:text-lg hover:text-blue-800 my-0 mx-auto">Click this link to view the healthcare physiotherapy appointment you booked in google calender</a>`)
                setIsError(false);
            } else {
    ...
    return {
        handlePhysiotherapyAppointment,
        message,
        isError,
        isLoading
    }
};
export default useHealthcarePhysiotherapySession;